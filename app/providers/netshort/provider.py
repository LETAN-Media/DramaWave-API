"""NetShort provider stub (research only, no production capability claimed)."""
...
class NetShortProvider(DramaProvider):
    name = 'netshort'
    ...
    async def search(self, query: str) -> list[ProviderSeries]:
        raise NotImplementedError('NetShort provider not implemented')
